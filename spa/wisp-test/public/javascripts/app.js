...
window.require.register("controllers/base/controller", function(exports, require, module) {
  var Chaplin, Controller, HeaderView, SiteView,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
window.require.register("initialize", function(exports, require, module) {
  ...
  $(function() {
    ...
    try {
      ...
      return alert("Factorial (wisp) de 7 = " + window.app.factorial(7));
    } catch (e) {
...
window.require.register("utils/utils_c", function(exports, require, module) {
  var sumac;
...
window.require.register("utils/utils_w", function(exports, require, module) {
  var sumaw = function(a, b) {
    return a + b;
  };
  module.exports.sumaw = sumaw;
